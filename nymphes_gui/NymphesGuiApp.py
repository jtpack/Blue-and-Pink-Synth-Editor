...
class NymphesGuiApp(App):
    ...
    def on_start(self):
        ...
        self._curr_width = Window.width
        self._curr_height = Window.height

        Logger.debug(f'Window size: {self._curr_width}, {self._curr_height}')
    ...
    def _set_presets_spinner_first_option_on_main_thread(self, new_option_text):
        """
